...
export default (state = initialState, action) => {
    switch(action.type) {
        case ADD_PLACE:
            ...
            action.placeData.title, action.placeData.image, action.placeData.address, action.placeData.coords.lat,
        ...
        case SET_PLACES:
            return {
                places: action.places.map(place => new Place(place.id.toString(),
